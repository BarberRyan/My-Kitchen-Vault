...
namespace MyKitchenVault
{
    public class Util_DBInterface
    {
        ...
        /// <summary>
        /// Retrieves all recipes marked as "favorites" by the active user
        /// </summary>
        /// <param name="favlist">list of recipe IDs as a comma separated list (retrieved from the usersettings.xml file</param>
        /// <returns>List information about recipes to poplate the data grid</returns>
        ...
        /// <summary>
        /// Retrieves a recipe from database data
        /// </summary>
        /// <param name="recipeID">ID of the recipe to retrieve</param>
        /// <returns>tuple containing the recipe object and the current user's rating of it</returns>
        ...
        /// <summary>
        /// Sends a recipe rating to the database
        /// </summary>
        /// <param name="recipeID">ID of the recipe to add the rating to</param>
        /// <param name="rating">Decimal rating from 0.0 to 5.0</param>
        ...
        public static (List<string>, List<string>, List<string>, List<string>, List<string>, Dictionary<string, string>) GetAutocompleteLists()
        {
            ...
            Dictionary<string, string> ac_name_pairs = new Dictionary<string, string>();
            ...
            using (SqlConnection c = new SqlConnection(user_cs))
            {
                ...
                while (reader.Read())
                {
                    try
                    {
                        ac_name_pairs.Add(reader.GetString(0), reader.GetString(1));
                    }
                    catch { }
                }

                return (ac_recipe_name, ac_ingredient_name, ac_ingredient_plural_name, ac_unit_name, ac_all_tags, ac_name_pairs);
            }
        }
    }
}
